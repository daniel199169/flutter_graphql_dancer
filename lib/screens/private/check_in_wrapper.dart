...
class CheckInWrapper extends StatefulWidget {
  @override
  _CheckInWrapperState createState() => _CheckInWrapperState();
}

class _CheckInWrapperState extends State<CheckInWrapper> {
