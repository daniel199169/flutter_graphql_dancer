...
import 'message_mykid_new_message.dart';
import 'message.dart';
import 'message_mykid.dart';
import 'notification.dart';
import 'ranking.dart';

class MessageMyKidsNewMessageWrapper extends StatefulWidget {
  @override
  _MessageMyKidsNewMessageWrapperState createState() =>
      _MessageMyKidsNewMessageWrapperState();
}

class _MessageMyKidsNewMessageWrapperState
    extends State<MessageMyKidsNewMessageWrapper> {
  ...
  Widget _resolveBody(int index) {
    switch (index) {
      ...
      default:
        return MessageMyKidsNewMessage();
    }
  }
