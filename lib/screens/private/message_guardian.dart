...
class MessageGuardian extends StatefulWidget {
  @override
  _MessageGuardianState createState() => _MessageGuardianState();
}

class _MessageGuardianState extends State<MessageGuardian> {
      ...
      child: ListView(
        children: <Widget>[
          ...
          Container(
            ...
            color: Colors.white,
            child: Text(
              'Odhod na bazen je ob 14h! Dobimo se pri recepciji 5min prej :)',
