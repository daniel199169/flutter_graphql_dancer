...
class ScheduleClassWrapper extends StatefulWidget {
  @override
  _ScheduleClassWrapperState createState() => _ScheduleClassWrapperState();
}

class _ScheduleClassWrapperState extends State<ScheduleClassWrapper> {
