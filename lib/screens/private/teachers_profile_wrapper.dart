...
class TeachersProfileWrapper extends StatefulWidget {
  final User teacher;

  TeachersProfileWrapper({this.teacher});

  @override
  _TeachersProfileWrapperState createState() => _TeachersProfileWrapperState();
}

class _TeachersProfileWrapperState extends State<TeachersProfileWrapper> {
