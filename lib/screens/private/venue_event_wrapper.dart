...
class VenueEventWrapper extends StatefulWidget {
  @override
  _VenueEventWrapperState createState() => _VenueEventWrapperState();
}

class _VenueEventWrapperState extends State<VenueEventWrapper> {
