...
class RankingWrapper extends StatefulWidget {
  @override
  _RankingWrapperState createState() => _RankingWrapperState();
}

class _RankingWrapperState extends State<RankingWrapper> {
