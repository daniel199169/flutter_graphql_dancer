...
class MessageLostWrapper extends StatefulWidget {
  @override
  _MessageLostWrapperState createState() => _MessageLostWrapperState();
}

class _MessageLostWrapperState extends State<MessageLostWrapper> {
